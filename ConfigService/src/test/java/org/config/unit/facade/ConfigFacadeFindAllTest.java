...
class ConfigFacadeFindAllTest extends BaseConfigFacadeTest {
    ...
    void findAll_Success() {
        ...
        ConfigDto dto1 = new ConfigDto("config1", "Popis 1", 1000, "Agent 1", "https://example1.com", null, List.of());
        ConfigDto dto2 = new ConfigDto("config2", "Popis 2", 2000, "Agent 2", "https://example2.com", null, List.of());
